...
INSERT INTO schedule (schedule_id, area_name, section, schedule_type, time, create_at, user_id)
VALUES
    (UUID(), 'Main Area', 'Section K', 'm', '08:00', NOW(), (SELECT user_id FROM User WHERE email = 'admin@example.com')),
    (UUID(), 'Main Area', 'Section L', 's', '12:00', NOW(), (SELECT user_id FROM User WHERE email = 'admin@example.com')),
    (UUID(), 'Main Area', 'Section M', 'n', '16:00', NOW(), (SELECT user_id FROM User WHERE email = 'admin@example.com')),
    (UUID(), 'Main Area', 'Section N', 'm', '08:00', NOW(), (SELECT user_id FROM User WHERE email = 'admin@example.com')),
    (UUID(), 'Main Area', 'Section O', 's', '12:00', NOW(), (SELECT user_id FROM User WHERE email = 'admin@example.com'));
   
INSERT INTO schedule (schedule_id, area_name, section, schedule_type, time, create_at, user_id)
VALUES
    (UUID(), 'Main Area', 'Section K', 'm', '08:00', DATE_SUB(NOW(), INTERVAL 1 DAY), (SELECT user_id FROM User WHERE email = 'admin@example.com'));
   INSERT INTO schedule (schedule_id, area_name, section, schedule_type, time, create_at, user_id)
values
    (UUID(), 'Main Area', 'Section L', 's', '12:00', DATE_SUB(NOW(), INTERVAL 1 DAY), (SELECT user_id FROM User WHERE email = 'admin@example.com'));
   INSERT INTO schedule (schedule_id, area_name, section, schedule_type, time, create_at, user_id)
VALUES
    (UUID(), 'Main Area', 'Section M', 'n', '16:00', DATE_SUB(NOW(), INTERVAL 1 DAY), (SELECT user_id FROM User WHERE email = 'admin@example.com'));
   INSERT INTO schedule (schedule_id, area_name, section, schedule_type, time, create_at, user_id)
VALUES
    (UUID(), 'Main Area', 'Section N', 'm', '08:00', DATE_SUB(NOW(), INTERVAL 1 DAY), (SELECT user_id FROM User WHERE email = 'admin@example.com'));
   INSERT INTO schedule (schedule_id, area_name, section, schedule_type, time, create_at, user_id)
VALUES
    (UUID(), 'Main Area', 'Section O', 's', '12:00', DATE_SUB(NOW(), INTERVAL 1 DAY), (SELECT user_id FROM User WHERE email = 'admin@example.com'));
